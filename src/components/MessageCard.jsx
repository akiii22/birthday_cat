...
function MessageCard({ message, name, image, delay = 0 }) {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col bg-white/70 w-[400px] max-h-[500px] justify-between items-center px-6 py-8 rounded-md shadow-md backdrop-blur-md border border-white/30"
    >
